...
const cacheName = 'Key_LoopsFunctionsStringsNumbers-2021-09-19 20:54:02.329810'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Key_LoopsFunctionsStringsNumbers'.length) === 'Key_LoopsFunctionsStringsNumbers') {
